...
std::string story[] = {
  ...
  "Info: Please enter a speed from 1 - 20. The lower the speed, the faster text will erase from the screen.\nIt will be easier to read at higher numbers, but the game will move faster at a lower number.\nYou can change this later in the game options.\nEnter a value now: ",
  "Info: Welcome, adventurer.\nEnter your name here: ",
  "Info: Would you like to start the tutorial or skip to the story? (For tutorial, type \"t\", for the story, type \"s\"): ",
  "Info: Hello, ",
  ...
  "Tutorial: Watch it, there's an enemy ahead!\n",
  "Tutorial: You don't have a weapon equipped! If you haven't picked up a weapon, try using p to pick find one. If you have, use e to equip your weapon.\n",
  "Tutorial: You have a weapon! Use 'a' to attack the enemy!\n",
  "Tutorial: Good job. You've defeated your first enemy. If you want to relax your arms, use 'u' to unequip your weapon! This is optional, of course.\nIf you'd like to move around, use 'm' and pick a direction.\n", 
  /*Story starts here*/
  "GUIDE: Alright, looks like you know the controls. Now, welcome to Zandris. You may have lost your memory after the collapse of Orpheum, so allow me to clue you in.\nThe sky you see above you is actually the ocean K'ver, and those stars are living leviathans. They've been docile until now, so we don't know what their intentions are, but at least they give us light.\nMost people, including you, have been corrupted by the side effects of magic and Orpheum collapsing. You, however, are special, patient 0. You can earn your memories back. However, it won't be easy. To start with, give this voice in your head a name, will you?\n",
  "Info: Enter your guide's name. This cannot be changed later on, so choose carefully!: ", // Yes, the guide dies
  ", I like that! Thanks! Now, let's get to it.\n",
  ": Firstly, here's something cool. Let's go back about a few hours, shall we?\n", // If you look in ../extra/lore.txt, you'll see that a cutscene is mentioned at the beginning. Since I'm limited by this text based game, I'm just typing it out.
  ...
  "???: My my, what have we here? A bug, escaping it's true world to decieve another underneath it?\nThis is a major offense, begone, insect.",
  ": Wait, no, no! I was trying to- DON'T DUST ME!\n",
  "Info: To \"dust\" something in this world is the equivilant of killing it in our world"
};
